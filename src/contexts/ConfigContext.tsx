...
// types
import { CustomizationProps, FontFamily, I18n, PresetColor, ThemeMode } from 'types/config';
...
function ConfigProvider({ children }: ConfigProviderProps) {
  const [config, setConfig] = useLocalStorage('lobby-next-config', initialState);

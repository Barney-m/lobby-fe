      ...
      <AppBar sx={{ bgcolor: 'transparent', color: theme.palette.text.primary, boxShadow: 'none' }}>
        <Container disableGutters={matchDownMd}>
          <Toolbar sx={{ px: { xs: 1.5, md: 0, lg: 0 }, py: 2 }}>
            ...
            >
              {session ? (
                <Link href={DEFAULT_PATH} className="header-link" color="white" target="_blank" underline="none">
                  Dashboard
                </Link>
              ) : (
                <Link href="/login" className="header-link" color="white" target="_blank" underline="none">
                  Login
                </Link>
              )}
